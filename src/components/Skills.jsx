    ...
    return (
        <section id="technology-skills" className="myBgColor skillsSection">
            <div className="container myTextColor">
                ...
                <p className="text-center mt-3">In my journey as a web developer, I've had the opportunity to acquire deep competence in a variety of technologies and skills. My experience extends from using fundamental languages like <a className="myLinkStyle" href="#html-icon">HTML</a> and <a className="myLinkStyle" href="#css-icon">CSS</a>, which form the basis of all my web projects, to more complex frameworks like <a className="myLinkStyle" href="#angular-icon">Angular</a> and <a className="myLinkStyle" href="#react-icon">React</a>, which allow me to build interactive and responsive web applications.
                    I've augmented my expertise with <a className="myLinkStyle" href="#php-icon">PHP</a>, an essential server-side scripting language for dynamic web development. My mastery of <a className="myLinkStyle" href="#js-icon">JavaScript</a> plays a crucial role in this, enabling me to animate sites and applications with dynamic and engaging functionalities.</p>
                <p className="text-center">Alongside front-end development, I've developed solid competencies in the CMS field, particularly with <a className="myLinkStyle" href="#wordpress-icon">WordPress</a>, which I use to create customized websites, from blogs to e-commerce platforms, supported by <a className="myLinkStyle" href="#woo-icon">WooCommerce</a> for optimal online commerce management. My coding efficiency is further enhanced by using development tools like <a className="myLinkStyle" href="#vsc-icon">Vscode</a>, which optimizes my workflow, and <a className="myLinkStyle" href="#gh-icon">GitHub</a>,
                    which I use for code management and collaboration with other developers. <a className="myLinkStyle" href="#fz-icon">FileZilla</a> has become an indispensable asset in my toolkit for its efficient file transfer capabilities via FTP.</p>
                <p className="text-center">Moreover, I have strong competence in <a className="myLinkStyle" href="#boot-icon">Bootstrap</a>, which allows me to create responsive layouts compatible across all devices and browsers, significantly speeding up the front-end development process. This combination of advanced technologies and versatile skills enables me to tackle complex web projects with creativity and precision, ensuring high-quality results for every client.</p>
            </div>
